...
def get_gaze_ratio(eye_points, facial_landmarks):
    ...
    if left_side_white != 0 and right_side_white != 0:
        ...
        gr = 0
    return gr
def get_gaze_ratio2(eye_points, facial_landmarks):
    left_eye_region = np.array([(facial_landmarks.part(eye_points[0]).x, facial_landmarks.part(eye_points[0]).y),
                                (facial_landmarks.part(eye_points[1]).x, facial_landmarks.part(eye_points[1]).y),
                                (facial_landmarks.part(eye_points[2]).x, facial_landmarks.part(eye_points[2]).y),
                                (facial_landmarks.part(eye_points[3]).x, facial_landmarks.part(eye_points[3]).y),
...
while True:
    ...
    for face in faces:
        ...
        # gaze detection
        gaze_ratio_left_eye = get_gaze_ratio2([36, 37, 38, 39, 40, 41], landmarks)
        gaze_ratio_right_eye = get_gaze_ratio2([42, 43, 44, 45, 46, 47], landmarks)
        gaze_Ratio = (gaze_ratio_right_eye + gaze_ratio_left_eye) / 2
